...
/**
 * Devuelve la fecha de hoy en formato 'America/Argentina/salta' 'd/m/Y'
 * @return string
 */
function hoy(){

    return \Carbon\Carbon::now('America/Argentina/Salta')->format('d/m/Y');
}

/**
 * Devuelve la fecha de hoy en formato 'America/Argentina/salta' 'Y-m-d' para guardar en la base de datos
 * @return string
 */
function hoyDb(){

    return \Carbon\Carbon::now('America/Argentina/Salta')->format('Y-m-d');
}
