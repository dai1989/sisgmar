...
class PagoController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        return view('pagos.create',["proveedores" => $proveedores]);
    ...
    public function edit($id)
    {
       ...
       return view ("pagos.edit",["pago"=>$pago,"proveedores"=>$proveedores]);
    ...
    flash('El pago al proveedor ha sido cancelada y dada como pagada correctamente')->success()->important();
