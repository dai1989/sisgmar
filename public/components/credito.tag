<credito>
    ...
    <button if={detail.length > 0 && autorizacion_id > 0} onclick={__save} class="btn btn-default btn-lg btn-block">
        Guardar
    </button>
    ...
    <script>
        ...
        __save() {
            $.post(baseUrl('credito/save'), {
                ...
                if(r.response) {
                    window.location.href = baseUrl('credito');
                } else {
        ...
        function __autorizacionAutocomplete(){
            var autorizacion = $("#autorizacion"),
                options = {
                url: function(q) {
                    return baseUrl('credito/findAutorizacion?q=' + q);
                },
                getValue: 'codigo',
                list: {
            ...
            autorizacion.easyAutocomplete(options);
        }
          ...
          function __userAutocomplete(){
            var user = $("#user"),
                options = {
                url: function(q) {
                    return baseUrl('credito/findUser?q=' + q);
                },
                getValue: 'name',
                list: {
                    onClickEvent: function() {
        ...
        function __productoAutocomplete(){
            var producto = $("#producto"),
                options = {
                url: function(q) {
                    return baseUrl('credito/findProducto?q=' + q);
                },
