<devolucion>
    <div class="well well-sm">
        <div class="row">
            <div class="col-xs-6">
                <input id="venta" class="form-control typeahead" type="text" placeholder="N° de factura" />
            </div>
            <div class="col-xs-2">
    ...
    <div class="row">
        ...
        <div class="col-xs-2">
            <input id="cantidad" class="form-control" type="text" placeholder="Cantidad a devolver" />
        </div>
         <div class="col-xs-2">
    ...
    <button if={detail.length > 0 && user_id > 0} onclick={__save} class="btn btn-default btn-lg btn-block">
        Guardar
    </button>
    ...
    <script>
        ...
        function __ventaAutocomplete(){
            ...
            venta.easyAutocomplete(options);
        }
