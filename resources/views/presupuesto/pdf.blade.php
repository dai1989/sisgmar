...
<html>
    ...
    <title>Reporte de recaudacion</title>
    <style>
        body {
        /*position: relative;*/
        /*width: 16cm;  */
            ...
            <div>
                <table id="facvendedor">
                    ...
                    <tbody>
                        <tr>
                            <td>{{$user->name}}</td> 
                            <td>{{date("d-m-Y", strtotime($pre->fecha_hora))}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table id="facarticulo">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th></th>
                            <th>SUBTOTAL</th>
                            <td>$ {{round($pre->total_venta/1.21,2)}}</td>
                        </tr>
                        <tr>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th>IVA</th>
                            <td>$ {{round($pre->total_venta-$pre->total_venta/1.21,2)}}</td>
                        </tr>
