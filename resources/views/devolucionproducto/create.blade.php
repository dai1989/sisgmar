...
<section class="content">
	<div class="box box-primary">
		<div class="box-header with-border">
			...
			{!! Form::open(array('url' => 'devolucionproducto', 'method'=>'POST', 'autocomplete' => 'off'))!!}
			{{Form::token()}}
			<div class="">
				<div class="panel panel-primary">
					<div class="panel-body">
                        ...
                        <select class="form-control" name="observacion" id="observacion" class="form-control">
                            <option value="">--Seleccionar--</option><br>
                            <option value="Donacion">Donacion</option>
                            <option value="Vencimiento">Vencimiento</option>
                            <option value="Desperfecto de fabrica">Desperfecto de fabrica</option>
	...
	function agregar(){
		...
		if (idproducto!="" && cantidad!="" && cantidad>0 && precio_venta!="")
		{
			if (stock_numero>=stock_cantidad)
			{
				...
				var fila='<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-danger btn-xs" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idproducto[]" value="'+idproducto+'">'+producto+'</td><td><input readonly type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input readonly type="number" name="precio_venta[]" value="'+precio_venta+'"></td>   <td>'+subtotal[cont]+'</td></tr>';
				cont++;
				limpiar();
				$('#total').html("$ " + total);
