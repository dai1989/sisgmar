...
@stop
{!! Form::open(array('url'=>'mensualpago-inicio', 'method'=>'GET', 'autocomplete'=>'off', 'role'=>'search')) !!}
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<input type="date" class="form-control" name="searchText"  placeholder="Buscar por fecha..." value="{{$searchText}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="row">
