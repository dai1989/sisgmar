...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company">
        <div><span class="textoMayu">Proveedor</span> {{$ingreso->razonsocial}}</div>
        <div><span class="textoMayu">{{$ingreso->cuit}}</span></div>
      
        
       
      </div>
      <div id="project" class="clearfix";>
        <div><span class="textoMayu">{{$config->app.name}}</span> {{$config->lema}}</div>
      ...
      <table>
        ...
        <tbody style="border-top: 2px solid #337ab7;">
          ...
          <tr>
            ...
            <td style="border-top: 2px solid #337ab7;"></td>
            <td style="border-top: 2px solid #337ab7;"></td>
            <td class="text-derecha" style="border-top: 2px solid #337ab7;">{{number_format($ingreso->total, 2, '.', '')}}</td>
          </tr>
        </tbody>
      </table>
    </main>
