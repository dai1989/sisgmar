							...
							<table class="table table-striped table-bordered table-condensed table-hover">
								...
								<tbody>
									...
									<th>
										...
										<input type="number" class="form-control" value="0" placeholder="Tarjeta de Debito" min="0"  name="tarjeta_debito">
									</th>
									<th>
										<label for="tarjeta_credito">Tarjeta de Credito</label>
										<input type="number" class="form-control" value="0" placeholder="Tarjeta de Credito" min="0" name="tarjeta_credito">
									</th>
									<th>
										<label for="efectivo">Efectivo</label>
										<input type="number" class="form-control" value="0" placeholder="Efectivo" min="0" name="paga">
									</th>
								</tdbody>
							</table>
						</div>
...
@push('scripts')
	...
	total=0;
	$("#guardar").hide();
	$("#pproducto").change(mostrarValores);

	function mostrarValores(){
		datosProducto=document.getElementById('pproducto').value.split('_');
	...
	function agregar(){
		...
		var producto=$("#pproducto option:selected").text();
